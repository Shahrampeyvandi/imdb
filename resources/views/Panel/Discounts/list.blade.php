            ...
            <table id="example1" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach ($discount->plan as $plan)
                                {{$plan->name}} <br/>
                            @endforeach
                        </td>
                        <td class="text-success">{{$discount->d_code}}</td>
                        <td class="text-success">{{$discount->percent}}</td>
                        <td class="text-info">{{\Morilog\Jalali\Jalalian::forge($discount->expire_date)->format('%B %d، %Y')}}</td>

                        <td>
                        <a href="{{route('Panel.Discount.Edit',['id' => $discount->id])}}" class="btn btn-sm btn-info">ویرایش</a>
                        </td>
                        @endforeach
