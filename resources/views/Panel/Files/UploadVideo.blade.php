...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
                ...
                <table id="example1" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="#" data-id="{{$video->id}}" data-toggle="modal" data-target="#deletemodal" class="btn btn-danger btn-sm">حذف</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
           ...
           @endif
            <form class="video" action="{{route('Panel.UploadVideo')}}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            @foreach (\App\Quality::all() as $key => $item)
                                 ...
                                 <input type="radio" id="{{$key+1}}" name="quality" value="{{$item->quality}}" class="custom-control-input"
                                    {{$key == 0 ? 'checked' : ''}}>
                            ...
                            <a href="#" onclick="addQuality(event)" class="btn btn-sm btn-success mt-2"><i class="fas fa-plus-circle"></i></a>
                        </div>
                        <div class="form-group col-md-3">
